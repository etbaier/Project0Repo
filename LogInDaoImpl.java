...
//			}
	...
	public User_Acc register(String username, String password, String fname, String lname, long phone, String dob,
		...
		User u = new User(username, fname, lname, null, ssn, address, email, password);
		...
		try {
			...
			throw new BusinessException("Invalid Date, Homie");
		}
		...
		try (Connection connection = OracleConnection.getConnection()) {
			...
			Checking_Account c = new Checking_Account(ua.getUid(), 0, 0, 0, ua);

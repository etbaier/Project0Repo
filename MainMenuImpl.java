...
//					long act = sc.nextLong();
					...
					log.info("You are about to deposit $" + amt);
					...
					if (ch2 == 1) {
						...
						mm.depositChecking((float) amt, u.getCa());
						log.info("Deposit Complete! Your new balance is $"+u.getCa().getBalance());
...
//					long act2 = sc.nextLong();
					...
					log.info("You are about to withdawl $" + amt2);
					log.info("Enter 1 to confirm transaction or 2 to go back.");
					log.info("1) Confirm");
					log.info("2) Go Back");
					ch2 = Integer.parseInt(sc.next());
...
//					long acc = sc.nextLong();
					...
					log.info(mm.getBalance(u.getCa()));
					}catch(BusinessException e) {
						System.out.println(e);
